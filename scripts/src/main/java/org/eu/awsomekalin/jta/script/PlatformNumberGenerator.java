...
public class PlatformNumberGenerator {
    ...
    public static void main(String[] args) {
        ...
        String modelOutputDir = "C:\\Users\\emzyy\\Desktop\\Jesses-Transit-Addon\\fabric\\src\\main\\resources\\assets\\jta\\models\\block\\sign\\generated\\platform_number_side";
        String blockstateOutputDir = "C:\\Users\\emzyy\\Desktop\\Jesses-Transit-Addon\\fabric\\src\\main\\resources\\assets\\jta\\blockstates\\sign\\platform_number_side";
        String itemOutputDir = "C:\\Users\\emzyy\\Desktop\\Jesses-Transit-Addon\\fabric\\src\\main\\resources\\assets\\jta\\models\\item\\sign\\platform_number_side";

        processDirectory(new File(baseDir), new File(modelOutputDir), new File(blockstateOutputDir), new File(itemOutputDir), "platform_number_side");
    ...
    private static void processDirectory(File inputDir, File modelOutputDir, File blockstateOutputDir, File itemOutputDir, String parentType) {
        ...
        if (files != null) {
            for (File file : files) {
                ...
                String inputName = "sign/generated/" + parentType + "/" + baseName + "/" + baseName + "_" + parentType;
                String capitalizedFullReference = (parentType + "_" + baseName).toUpperCase().replace("/", "_");
                blockInitLines.add(String.format(
                        "public static final BlockRegistryObject %s = Init.REGISTRY.registerBlockWithBlockItem(new Identifier(Init.MOD_ID, \"%s\"), () -> new Block(new PlatformNumber()), CreativeTabInit.JTA_SIGNS);",
    ...
    private static void generateBlockstateFile(File blockstateDir, String parentType, String baseName) {
        String modelPath = "jta:block/sign/generated/" + parentType + "/" + baseName + "/" + baseName + "_" + parentType;
    ...
    private static void generateItemFile(File pngFile, File outputDir, String parentType, String baseName) {
        ...
        String itemContent = String.format(
                "{\n" +
                        "  \"parent\": \"jta:block/sign/generated/" + parentType + "/%s/%s_" + parentType + "\"\n" +
                        "}", baseName, baseName
        );
    ...
    private static void generateTextFiles(File baseDir) {
        File blockInitFile = new File(baseDir, "Platofmr nUmber BlockInit update.txt");
