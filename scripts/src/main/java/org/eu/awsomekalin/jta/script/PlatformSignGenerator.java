...
public class PlatformSignGenerator {
    ...
    public static void main(String[] args) {
        ...
        String modelOutputDir = "C:\\Users\\emzyy\\Desktop\\Jesses-Transit-Addon\\fabric\\src\\main\\resources\\assets\\jta\\models\\block\\sign\\generated\\platform_sign";
        String blockstateOutputDir = "C:\\Users\\emzyy\\Desktop\\Jesses-Transit-Addon\\fabric\\src\\main\\resources\\assets\\jta\\blockstates\\sign\\platform_sign";
        String itemOutputDir = "C:\\Users\\emzyy\\Desktop\\Jesses-Transit-Addon\\fabric\\src\\main\\resources\\assets\\jta\\models\\item\\sign\\platform_sign";

        processDirectory(new File(baseDir), new File(modelOutputDir), new File(blockstateOutputDir), new File(itemOutputDir), "platform_sign");
        ...
        if (files != null) {
            for (File file : files) {
                ...
                blockInitLines.add(String.format(
                        "public static final BlockRegistryObject %s = Init.REGISTRY.registerBlockWithBlockItem(new Identifier(Init.MOD_ID, \"%s\"), () -> new Block(new PlatformSign()), CreativeTabInit.JTA_SIGNS);",
    ...
    private static void generateTextFiles(File baseDir) {
        File blockInitFile = new File(baseDir, "Platofmr sign BlockInit update.txt");
