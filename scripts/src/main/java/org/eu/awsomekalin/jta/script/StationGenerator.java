...
public class StationGenerator {
    ...
    public static void main(String[] args) {
        ...
        String modelOutputDir = "C:\\Users\\emzyy\\Desktop\\Jesses-Transit-Addon\\fabric\\src\\main\\resources\\assets\\jta\\models\\block\\station\\generated";
        String blockstateOutputDir = "C:\\Users\\emzyy\\Desktop\\Jesses-Transit-Addon\\fabric\\src\\main\\resources\\assets\\jta\\blockstates\\station\\generated";
        String itemOutputDir = "C:\\Users\\emzyy\\Desktop\\Jesses-Transit-Addon\\fabric\\src\\main\\resources\\assets\\jta\\models\\item\\station\\generated";

        processDirectory(new File(baseDir), new File(modelOutputDir), new File(blockstateOutputDir), new File(itemOutputDir), "station_steps_left");
        processDirectory(new File(baseDir), new File(modelOutputDir), new File(blockstateOutputDir), new File(itemOutputDir), "station_steps_middle");
        processDirectory(new File(baseDir), new File(modelOutputDir), new File(blockstateOutputDir), new File(itemOutputDir), "station_steps_right");
        processDirectory(new File(baseDir), new File(modelOutputDir), new File(blockstateOutputDir), new File(itemOutputDir), "station_handrail");
    ...
    private static void processDirectory(File inputDir, File modelOutputDir, File blockstateOutputDir, File itemOutputDir, String parentType) {
        ...
        if (files != null) {
            for (File file : files) {
                ...
                String inputName = "jta:block/station/generated/" + baseName + "/" + baseName + "_" + parentType;
                String capitalizedFullReference = (parentType + "_" + baseName).toUpperCase().replace("/", "_");
                blockInitLines.add(String.format(
                        "public static final BlockRegistryObject %s = Init.REGISTRY.registerBlockWithBlockItem(new Identifier(Init.MOD_ID, \"%s\"), () -> new Block(new stationBase()), CreativeTabInit.JTA_SIGNS);",
    ...
    private static void generateModelFile(File pngFile, File outputDir, String parentType, String baseName) {
        ...
        String jsonContent = String.format(
                "{\n" +
                        "  \"parent\": \"jta:block/station/%s\",\n" +
                        "  \"textures\": {\n" +
                        "    \"color\": \"jta:block/station/%s\"\n" +
                        "  }\n" +
                        "}", parentType, baseName);
    ...
    private static void generateBlockstateFile(File blockstateDir, String parentType, String baseName) {
        String modelPath = "jta:block/station/generated/" + baseName + "/" + baseName + "_" + parentType;
    ...
    private static void generateItemFile(File pngFile, File outputDir, String parentType, String baseName) {
        ...
        String itemContent = String.format(
                "{\n" +
                        "  \"parent\": \"jta:block/station/generated/%s/%s_" + parentType + "\"\n" +
                        "}", baseName, baseName
        );
    ...
    private static void generateTextFiles(File baseDir) {
        File blockInitFile = new File(baseDir, "station BlockInit update.txt");
