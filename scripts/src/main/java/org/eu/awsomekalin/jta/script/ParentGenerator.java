...
public class ParentGenerator {
    ...
    private static void processDirectory(File modelOutputDir, File blockstateOutputDir, File itemOutputDir, String parentType) {
        if (true) {
            for (String file : Arrays.asList("oak_planks", "spruce_planks" ,"birch_planks", "jungle_planks", "acacia_planks", "dark_oak_planks", "mangrove_planks", "cherry_planks", "bamboo_planks", "stone", "cobblestone", "stone_bricks", "bricks", "andesite", "diorite", "granite", "calcite", "clay", "gravel")) {
                ...
                blockInitLines.add(String.format(
                        "public static final BlockRegistryObject %s = Init.REGISTRY.registerBlockWithBlockItem(new Identifier(Init.MOD_ID, \"%s\"), () -> new Block(new BlockWallBase()), CreativeTabInit.JTA_PARENTS);",
    ...
    private static void generateTextFiles(File baseDir) {
        File blockInitFile = new File(baseDir, "BlockIni parent update.txt");
