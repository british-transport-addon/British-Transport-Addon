...
public class RoundelBaseRender<T extends RoundelBase.RoundelBaseBlockEntity> extends BlockEntityRenderer<T> implements IGui, IDrawing {
    ...
    public RoundelBaseRender(Argument dispatcher, float maxWidth, float maxScale, float xOffset, float yOffset, float zOffset, float xTilt, int textColor, Identifier font) {
        super(dispatcher);
