...
public class RoundelSmallSignBaseRender<T extends RoundelSmallSignBase.RoundelBaseBlockEntity> extends BlockEntityRenderer<T> implements IGui, IDrawing {
    ...
    public RoundelSmallSignBaseRender(Argument dispatcher, float maxWidth, float maxScale, float xOffset, float yOffset, float zOffset, float xTilt, int textColor, Identifier font) {
        super(dispatcher);
