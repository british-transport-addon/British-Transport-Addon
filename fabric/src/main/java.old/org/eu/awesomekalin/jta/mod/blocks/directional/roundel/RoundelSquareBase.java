...
public class RoundelSquareBase extends DirectionalBlockExtension implements BlockWithEntity {
    ...
    public static class RoundelBaseBlockEntity extends OneLineBlockEntity {
        public RoundelBaseBlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypeInit.ROUNDEL_SQUARE.get(), pos, state, "");
        }
        public RoundelBaseBlockEntity(BlockPos pos, BlockState state, String defaultText) {
            super(BlockEntityTypeInit.ROUNDEL_SQUARE.get(), pos, state, defaultText);
        }
