...
public class RenderNationalRail10Clock extends RenderBritishPIDS<NationalRail10Clock.TileEntityNationalRail10Clock> {
    ...
    public RenderNationalRail10Clock(Argument dispatcher, float maxWidth, float maxScale, float xOffset, float yOffset, float zOffset, float xTilt, int textColor) {
    ...
    @Override
    public void render(NationalRail10Clock.TileEntityNationalRail10Clock entity, float tickDelta, GraphicsHolder graphicsHolder, int light, int overlay) {
