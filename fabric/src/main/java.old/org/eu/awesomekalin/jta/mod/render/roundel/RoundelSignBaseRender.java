...
public class RoundelSignBaseRender<T extends RoundelSignBase.RoundelBaseBlockEntity> extends BlockEntityRenderer<T> implements IGui, IDrawing {
    ...
    public RoundelSignBaseRender(Argument dispatcher, float maxWidth, float maxScale, float xOffset, float yOffset, float zOffset, float xTilt, int textColor, Identifier font) {
        super(dispatcher);
