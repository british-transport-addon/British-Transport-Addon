...
public class BlockInit {
    ...
    public static final BlockRegistryObject BRITISH_SIGNAL_LIGHT_4_ASPECT = Init.REGISTRY.registerBlockWithBlockItem(new Identifier(Init.MOD_ID, "british_signal_light_4_aspect"), () -> new Block(new BritishSignal4Aspect(BlockHelper.createBlockSettings(false, false))), CreativeTabInit.JTA_RAILWAYS);
    ...
    public static final BlockRegistryObject DIGITAL_ROUTE_SIGNAL = Init.REGISTRY.registerBlockWithBlockItem(new Identifier(Init.MOD_ID, "digital_route_signal"), () -> new Block(new DigitalRouteSignal(BlockHelper.createBlockSettings(false, false).strength(4.0f).nonOpaque().dynamicBounds())), CreativeTabInit.JTA_BLOCKS);
    ...
    public static final BlockRegistryObject DISPLAY_1x1 = Init.REGISTRY.registerBlockWithBlockItem(new Identifier(Init.MOD_ID, "display_1x1"), () -> new Block(new DisplayBlock(1, 1)), CreativeTabInit.JTA_BLOCKS);
    ...
    public static final BlockRegistryObject LARGE_DIGITAL_SIGNAL_LIGHT_1_ASPECT = Init.REGISTRY.registerBlockWithBlockItem(new Identifier(Init.MOD_ID, "large_digital_signal_light_1_aspect"), () -> new Block(new LargeDigitalSignal1Aspect(BlockHelper.createBlockSettings(false, false))), CreativeTabInit.JTA_RAILWAYS);
    ...
    public static final BlockRegistryObject SHUNT_SIGNAL = Init.REGISTRY.registerBlockWithBlockItem(new Identifier(Init.MOD_ID, "shunt_signal"), () -> new Block(new ShuntSignal(BlockHelper.createBlockSettings(false, false))), CreativeTabInit.JTA_RAILWAYS);
    public static final BlockRegistryObject SHUNT_SIGNAL_RIGHT = Init.REGISTRY.registerBlockWithBlockItem(new Identifier(Init.MOD_ID, "shunt_signal_right"), () -> new Block(new ShuntSignalRight(BlockHelper.createBlockSettings(false, false))), CreativeTabInit.JTA_RAILWAYS);
    ...
    public static final BlockRegistryObject TRAM_JUNCTION_SIGNAL = Init.REGISTRY.registerBlockWithBlockItem(new Identifier(Init.MOD_ID, "tram_junction_signal"), () -> new Block(new TramJunctionSignal(BlockHelper.createBlockSettings(false, false))), CreativeTabInit.JTA_RAILWAYS);
