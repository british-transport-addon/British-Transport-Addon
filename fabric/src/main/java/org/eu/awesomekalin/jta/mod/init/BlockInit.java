...
public class BlockInit {
    ...
    public static final BlockRegistryObject DISPLAY = Init.REGISTRY.registerBlockWithBlockItem(new Identifier(Init.MOD_ID, "display"), () -> new Block(new DisplayBlock()), CreativeTabInit.JTA_BLOCKS);
