...
import org.eu.awesomekalin.jta.mod.entity.FourLineBlockEntity;
...
public class LondonStreetSign2x2 extends DirectionalBlockExtension implements BlockWithEntity {
    public LondonStreetSign2x2() {
    ...
    public static class LondonStreetSign2x2BlockEntity extends FourLineBlockEntity {
        public LondonStreetSign2x2BlockEntity(BlockPos pos, BlockState state) {
            super(
                    BlockEntityTypeInit.LONDON_STREET_SIGN_2X2.get(),
                    pos,
                    state,
                    "Oxford",
                    "Street",
