...
public class RoundelSmallSignBase extends DirectionalBlockExtension implements BlockWithEntity {
    ...
    public static class RoundelBaseBlockEntity extends OneLineBlockEntity {
        public RoundelBaseBlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypeInit.ROUNDEL_SMALL.get(), pos, state, "");
        }
        public RoundelBaseBlockEntity(BlockPos pos, BlockState state, String defaultText) {
            super(BlockEntityTypeInit.ROUNDEL_SMALL.get(), pos, state, defaultText);
        }
