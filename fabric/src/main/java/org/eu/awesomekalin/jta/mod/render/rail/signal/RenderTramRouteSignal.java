...
public class RenderTramRouteSignal<T extends DigitalRouteSignal.BlockEntity> extends BlockEntityRenderer<T> implements IGui, IDrawing {
    ...
    public RenderTramRouteSignal(Argument dispatcher, float maxWidth, float maxScale, float xOffset, float yOffset, float zOffset, float xTilt, int textColor, Identifier font) {
        super(dispatcher);
