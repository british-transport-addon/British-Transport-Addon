...
public class LondonStreetSign3x2_5 extends DirectionalBlockExtension implements BlockWithEntity {
    public LondonStreetSign3x2_5() {
    ...
    public static class LondonStreetSign2x2BlockEntity extends FourLineBlockEntity {
        public LondonStreetSign2x2BlockEntity(BlockPos pos, BlockState state) {
            super(
                    BlockEntityTypeInit.LONDON_STREET_SIGN_3X2_5.get(),
                    pos,
                    state,
                    "Victoria",
                    "Embankment",
