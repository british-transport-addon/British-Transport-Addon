...
public class LondonStreetSign2x2_5Render<T extends LondonStreetSign2x2_5.LondonStreetSign2x2BlockEntity> extends BlockEntityRenderer<T> implements IGui, IDrawing {
    ...
    public LondonStreetSign2x2_5Render(Argument dispatcher, float maxWidth, float maxScale, float xOffset, float yOffset, float zOffset, float xTilt, int textColor, Identifier font) {
        super(dispatcher);
