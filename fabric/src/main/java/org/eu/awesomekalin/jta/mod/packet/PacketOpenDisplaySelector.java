...
public class PacketOpenDisplaySelector extends PacketHandler {
    ...
    public PacketOpenDisplaySelector(PacketBufferReceiver packetBufferReceiver) {
        ...
        this.width = packetBufferReceiver.readInt();
        this.height = packetBufferReceiver.readInt();
    }

    public PacketOpenDisplaySelector(BlockPos pos, ObjectArrayList<String> selectedIds, int width, int height) {
        this.pos = pos;
    ...
    public void runClient() {
        ClientPacketHelper.openDisplaySelector(pos, selectedIds, width, height);
    }
}
