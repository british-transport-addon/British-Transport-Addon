...
public class RenderNationalRail10Clock extends RenderBritishPIDS<NationalRail10Clock.TileEntityNationalRail10Clock> {
    ...
    public RenderNationalRail10Clock(
            Argument dispatcher,
            float maxWidth,
            float maxScale,
            float xOffset,
    ...
    @Override
    public void render(@Nonnull NationalRail10Clock.TileEntityNationalRail10Clock entity, float tickDelta, @Nonnull GraphicsHolder graphicsHolder, int light, int overlay) {
