...
public class TescoFuelStationPriceBoardTopRender<T extends FuelStationPriceBoardTop.FuelStationPriceBoardTopBlockEntity> extends BlockEntityRenderer<T> implements IGui, IDrawing {
    ...
    public TescoFuelStationPriceBoardTopRender(Argument dispatcher, float maxWidth, float maxScale, float xOffset, float yOffset, float zOffset, float xTilt, int textColor, Identifier font) {
        super(dispatcher);
