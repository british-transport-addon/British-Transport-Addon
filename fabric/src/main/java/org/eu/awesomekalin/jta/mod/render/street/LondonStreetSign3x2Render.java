...
public class LondonStreetSign3x2Render<T extends LondonStreetSign3x2.LondonStreetSign3x2BlockEntity> extends BlockEntityRenderer<T> implements IGui, IDrawing {
    ...
    public LondonStreetSign3x2Render(Argument dispatcher, float maxWidth, float maxScale, float xOffset, float yOffset, float zOffset, float xTilt, int textColor, Identifier font) {
        super(dispatcher);
