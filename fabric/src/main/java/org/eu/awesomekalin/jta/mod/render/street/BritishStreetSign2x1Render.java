...
public class BritishStreetSign2x1Render<T extends BritishStreetSign2x1.BritishStreetSign2x1BlockEntity> extends BlockEntityRenderer<T> implements IGui, IDrawing {
    ...
    public BritishStreetSign2x1Render(Argument dispatcher, float maxWidth, float maxScale, float xOffset, float yOffset, float zOffset, float xTilt, int textColor, Identifier font) {
        super(dispatcher);
