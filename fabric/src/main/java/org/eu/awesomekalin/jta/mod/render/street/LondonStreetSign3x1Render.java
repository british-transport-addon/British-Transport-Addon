...
public class LondonStreetSign3x1Render<T extends LondonStreetSign3x1.LondonStreetSign3x1BlockEntity> extends BlockEntityRenderer<T> implements IGui, IDrawing {
    ...
    public LondonStreetSign3x1Render(Argument dispatcher, float maxWidth, float maxScale, float xOffset, float yOffset, float zOffset, float xTilt, int textColor, Identifier font) {
        super(dispatcher);
