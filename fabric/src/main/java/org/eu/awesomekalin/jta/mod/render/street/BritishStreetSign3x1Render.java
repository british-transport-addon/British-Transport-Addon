...
public class BritishStreetSign3x1Render<T extends BritishStreetSign3x1.BritishStreetSign3x1BlockEntity> extends BlockEntityRenderer<T> implements IGui, IDrawing {
    ...
    public BritishStreetSign3x1Render(Argument dispatcher, float maxWidth, float maxScale, float xOffset, float yOffset, float zOffset, float xTilt, int textColor, Identifier font) {
        super(dispatcher);
