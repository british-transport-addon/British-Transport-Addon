...
public class RenderNationalRail3Clock extends RenderBritishPIDS<NationalRail3Clock.TileEntityNationalRail3Clock> {
    ...
    public RenderNationalRail3Clock(
            Argument dispatcher,
            float maxWidth,
            float maxScale,
            float xOffset,
    ...
    @Override
    public void render(@Nonnull NationalRail3Clock.TileEntityNationalRail3Clock entity, float tickDelta, @Nonnull GraphicsHolder graphicsHolder, int light, int overlay) {
