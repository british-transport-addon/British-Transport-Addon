...
public class RoundelSignBase extends DirectionalBlockExtension implements BlockWithEntity {

    private String defaultText;

    public RoundelSignBase(String defaultText) {
    ...
    public static class RoundelBaseBlockEntity extends OneLineBlockEntity {
        public RoundelBaseBlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypeInit.ROUNDEL_SIGN.get(), pos, state, "");
        }
        public RoundelBaseBlockEntity(BlockPos pos, BlockState state, String defaultText) {
            super(BlockEntityTypeInit.ROUNDEL_SIGN.get(), pos, state, defaultText);
        }
